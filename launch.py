...
def parse_args():
    ...
    parser.add_argument("--master_addr", default="127.0.0.2", type=str,
...
def main():
    ...
    for local_rank in range(0, args.nproc_per_node):
        ...
        cmd = [sys.executable, "-u", args.training_script, "--local_rank", str(local_rank)] + args.training_script_args
