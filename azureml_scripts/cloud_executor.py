...
parser.add_argument('--compute-target',         type=str,                    dest='compute_target',         default='lei4g1', help='The name of the compute target. Current options are {0}. Defaults to OXO-ML-CA-Comput'.format(list(COMPUTE_TARGET_TO_VM_SIZE.keys()), DEFAULT_COMPUTE_TARGET))
...
parser.add_argument('--experiment-tag-name',    type=str, dest='experiment_tag_name', default='swin_mini7', help='add experiment tag name')
...
#                 workspace=ws,
#                 datastore_name="tmp",
#                 account_name="zdaxseasia", # Storage account name
#                 container_name="v-miazhang", # Name of Azure blob container
#                 account_key="m0bb7W1egG4u/8mDk+3iIR9xIuZGXySqfApWwVP4tJ+YVXfrFbNbTyw1v8FZzG00LvXbhkljf+bTKx9xkMhveg==") # Storage account key
...
if args.use_docker:
    ...
    #                     username='lshi22',
    #                     password='HDJSJYl1991515'),
    #                 custom_docker_image='lshi22/mlcvnets:v1',
    #                 user_managed               =True,
