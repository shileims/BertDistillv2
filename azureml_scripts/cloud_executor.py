...
parser.add_argument('--compute-target',         type=str,                    dest='compute_target',         default='lei4g2', help='The name of the compute target. Current options are {0}. Defaults to OXO-ML-CA-Comput'.format(list(COMPUTE_TARGET_TO_VM_SIZE.keys()), DEFAULT_COMPUTE_TARGET))
...
parser.add_argument('--experiment-tag-name',    type=str, dest='experiment_tag_name', default='swin_mini1', help='add experiment tag name')
