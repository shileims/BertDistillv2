...
class SStock(BaseDataset):
    def __init__(self, data_path, transforms=None, is_train=True, fix_length=1483257, debug=False):
    ...
    def __getitem__(self, item):
        ...
        post_img = self.trans(raw_img)
        # texts
        sentence = idb[0]
        sentence_features = self.tokenizer(sentence, return_tensors='pt')
        return post_img, sentence_features
