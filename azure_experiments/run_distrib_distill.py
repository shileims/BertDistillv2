...
parser.add_argument('--experiment_name', type=str, default='distill_refactor_dist_1.4M')
...
if __name__ == '__main__':
    ...
    if not args.debug:
        os.system("python distributed_training.py \
                    ...
                    --distill-model {} \
                    --output_dir {} \
                    --node_num {}".format(vlmodel_pretrain, args.batch_size, dataset_path, args.debug_batch_size, args.val_num_samples, args.train_num_samples, stu_size, distill_model, output_dir, args.node_num))
    else:
        os.system("python distributed_training.py \
                    --vlmodel-pretrain {} \
                    --batch-size {} \
